...
bool readinbadrunlist(std::set<int> & badrun, TString csvfile="pp200Y12_badrun.list") {
...
int main( int argc, const char** argv ) {
	...
	// ------------------------------
	const char *defaults[] = {"Ntrk","Ntrk.root","ppMB","/home/fas/caines/ly247/Scratch/run12ppQA/pp200Y12PicoMB_sum*.root"};
	...
	readinbadrunlist(badrun,Form("%s/pp200Y12_badrun.list",ppjetpath));        


	TH1D *hNtrk = new TH1D("hNtrk","Charged multiplicity",100,0,100);
	...
	TFile *fout = new TFile("Ntrk_ppMB.root","RECREATE");
	hNtrk->Write();
	fout->Close();
